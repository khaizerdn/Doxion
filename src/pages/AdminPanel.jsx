      ...
      <Link to={to} style={{ textDecoration: 'none' }}>
        <li className="admin-item">
          {iconType === 'recipient' ? (
            ...
            <svg className="admin-icon" viewBox="0 0 24 24">
              <path d="M12 8c-2.21 0-4 1.79-4 4s1.79 4 4 4 4-1.79 4-4-1.79-4-4-4zm0 6c-1.1 0-2-.9-2-2s.9-2 2-2 2 .9 2 2-.9 2-2 2zm8.94-2.66c-.06-.42-.26-.81-.56-1.11l-1.47-1.47c-.59-.59-1.54-.59-2.12 0-.3.3-.49.69-.56 1.11-.06.42.06.85.34 1.13l1.47 1.47c.59.59 1.54.59 2.12 0 .28-.28.4-.71.34-1.13zM4.22 11.34c-.06.42.13.82.43 1.11l1.47 1.47c.59.59 1.54.59 2.12 0 .3-.3.49-.69.56-1.11.06-.42-.06-.85-.34-1.13l-1.47-1.47c-.59-.59-1.54-.59-2.12 0-.28.28-.4.71-.34 1.13zm16.56 5.66c.42-.06.81-.26 1.11-.56l1.47-1.47c.59-.59.59-1.54 0-2.12-.3-.3-.69-.49-1.11-.56-.42-.06-.85.06-1.13.34l-1.47 1.47c-.59.59-.59 1.54 0 2.12.28.28.71.4 1.13.34zM3.28 12.66c-.42.06-.81.26-1.11.56l-1.47 1.47c-.59.59-.59 1.54 0 2.12.3.3.69.49 1.11.56.42.06.85-.06 1.13-.34l1.47-1.47c.59-.59.59-1.54 0-2.12-.28-.28-.71-.4-1.13-.34z" />
            </svg>
          ) : (
            <svg className="admin-icon" viewBox="0 0 24 24">
